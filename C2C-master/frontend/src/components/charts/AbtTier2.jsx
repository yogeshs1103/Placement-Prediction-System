export const AbtTier2 = () => {
  const teamMembers = [
    {
      name: 'Vilas Dasalkar',
      photo: '/public/static/images/vilas_image.jpg',
      linkedin: 'https://www.linkedin.com/in/vilas-dasalkar-39978b253',
      github: 'https://github.com/vilasdasalkar',
      gmail: 'vilasdasalkar@gmail.com',
    },
