export const AbtTier1 = () => {
  const teamMembers = [
    {
      name: 'Nihar Jachak',
      photo: '/public/static/images/nihar_image.jpg',
      linkedin: 'https://www.linkedin.com/in/nihar-jachak-200117212',
      github:   'https://github.com/niharjachak' ,
      gmail:    'nihar.jachak@gmail.com'
    },
