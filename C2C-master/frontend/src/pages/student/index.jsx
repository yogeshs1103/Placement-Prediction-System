...
export const Student = () => {
  ...
  const onUploadClick = async (file) => {
    ...
    try {
      ...
      setresumeParseLoading(false)
      console.log(err)
      handleOpenSnackBar('Upcoming updates will bring improvements.', 'error')
    }
  }
                ...
                <div>
                  <h2 style={{ fontWeight: 200 }}>
                    ...
                    <span style={{ color: '#9d44c0' }}>
                      {Number(predictedData.placement_probability).toFixed(2)}%
                    </span>
                  </h2>
                  <h1>
                    <TfiHandPointRight /> Predicted Salary:{' '}
                    <span style={{ color: '#9d44c0' }}>
                      {Number(predictedData.predicted_salary).toFixed(2)}LPA
                    </span>
                  </h1>
                  <div>
                    <p
